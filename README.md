Project Overview
Ever wondered how Waze or Google Maps finds the fastest route to your destination? That's Dijkstra's Algorithm in action.
This project applies the same logic to a real map — the campus of Sede Lagunilla, Universidad Nacional (UNA), Costa Rica — finding the shortest walking path from the main building to the main entrance.
